...
<body>
    ...
    <div class="modal fade" id="addDataModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form id="dataForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="laki" placeholder="Masukkan Jumlah Laki-Laki">
                        </div>
                        <div class="form-group">
                            <label for="perempuan">Perempuan</label>
                            <input type="number" class="form-control" id="perempuan" placeholder="Masukkan Jumlah Perempuan">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="closeModals">Tutup</button>
